...
export function TestimonialsZone({ data, testimonialCount }: TestimonialsZoneProps) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-semibold text-zinc-100">Відгуки</h3>
        <p className="text-sm text-zinc-500 mt-1">Заголовок секції. Відгуки керуються окремо.</p>
      </div>
