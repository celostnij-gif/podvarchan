...
const IMAGES = [
  ...
  /* ── Anxiety deep dives ── */
  {
    ...
    title: 'Почему тревога',
    sub: 'не проходит годами',
    gradient: ['#2D1B1B', '#4A2525'],
    symbol: '🕰️',
    accent: COLORS.accentRose,
    uk: { title: 'Чому тривога', sub: 'не минає роками' },
  },
  {
    ...
    symbol: '🔒',
    accent: COLORS.accentTeal,
    uk: { title: 'Грудка в горлі', sub: 'при тривозі' },
  },
  {
    slug: 'pochemu-voznikaet-panika-nochyu',
    title: 'Паника ночью',
    sub: 'причины и решения',
    gradient: ['#1B1B2D', '#2A1B4A'],
    symbol: '🌙',
    accent: COLORS.accentPurple,
    uk: { title: 'Паніка вночі', sub: 'причини та рішення' },
  },
  {
    ...
    symbol: '🖤',
    accent: COLORS.gold,
    uk: { title: 'Страх смерті', sub: 'без причини' },
  },
  {
    ...
    symbol: '⚡',
    accent: COLORS.accentCoral,
    uk: { title: 'Внутрішня', sub: 'напруга' },
  },
  {
    slug: 'kak-perestat-boyatsya-budushchego',
    title: 'Как перестать',
    sub: 'бояться будущего',
    gradient: ['#1B2D1B', '#2A4A2A'],
    symbol: '🕊️',
    accent: COLORS.accentGreen,
    uk: { title: 'Як перестати', sub: 'боятися майбутнього' },
  },
  /* ── Psychosomatics deep dives ── */
  {
    slug: 'psikhosomatika-golovokruzheniya',
    title: 'Психосоматика',
    sub: 'головокружения',
    gradient: ['#1B2D1B', '#3A4A2A'],
    symbol: '🌀',
    accent: COLORS.accentGreen,
    uk: { title: 'Психосоматика', sub: 'запаморочення' },
  },
  {
    ...
    symbol: '🎗️',
    accent: COLORS.accentPurple,
    uk: { title: 'Біль у шиї', sub: 'психосоматика' },
  },
  {
  ...
  /* ── New 8 blog posts (SEO) ── */
  {
    slug: 'chto-takoe-eriksonovskiy-gipnoz',
    title: 'Эриксоновский гипноз',
    sub: 'Мягкий гипноз Милтона Эриксона',
    gradient: ['#1A1A2E', '#2D1B4E'],
    symbol: '🌀',
    accent: COLORS.accentPurple,
    uk: { title: 'Ериксонівський гіпноз', sub: 'М\'який метод Мілтона Еріксона' },
  },
  {
    slug: 'effektivna-li-gipnoterapiya-onlajn',
    title: 'Гипнотерапия онлайн',
    sub: 'Эффективно или нет?',
    gradient: ['#0F1B2D', '#1B3A4B'],
    symbol: '📊',
    accent: COLORS.accentBlue,
    uk: { title: 'Гіпнотерапія онлайн', sub: 'Чи ефективно?' },
  },
  {
    slug: 'kak-ostanovit-panicheskuyu-ataku',
    title: 'Паническая атака',
    sub: 'Как остановить за 5 минут',
    gradient: ['#2D1B1B', '#4A2525'],
    symbol: '🆘',
    accent: COLORS.accentRose,
    uk: { title: 'Панічна атака', sub: 'Як зупинити за 5 хвилин' },
  },
  {
    slug: 'kulturnyy-shok',
    title: 'Культурный шок',
    sub: 'Стадии адаптации в новой стране',
    gradient: ['#2D1B10', '#4A2A1A'],
    symbol: '🌍',
    accent: COLORS.accentCoral,
    uk: { title: 'Культурний шок', sub: 'Стадії адаптації в новій країні' },
  },
  {
    slug: 'nostalgiya-po-rodine',
    title: 'Ностальгия по родине',
    sub: 'Как справиться в эмиграции',
    gradient: ['#1B1B2D', '#3A2A3A'],
    symbol: '🏡',
    accent: COLORS.accentTeal,
    uk: { title: 'Ностальгія за батьківщиною', sub: 'Як впоратися в еміграції' },
  },
  {
    ...
    symbol: '🌆',
    accent: COLORS.accentBlue,
    uk: { title: 'Самотність', sub: 'в еміграції' },
  },
  {
    slug: 'postoyannaya-trevoga-bez-prichiny',
    title: 'Тревога без причины',
    sub: 'Почему и что делать',
    gradient: ['#2D1B1B', '#3D2525'],
    symbol: '🌫️',
    accent: COLORS.accentRose,
    uk: { title: 'Тривога без причини', sub: 'Чому і що робити' },
  },
  {
    slug: 'trevoga-posle-pereezda',
    title: 'Тревога после',
    sub: 'переезда в другую страну',
    gradient: ['#2D1B10', '#4A2A2A'],
    symbol: '🚚',
    accent: COLORS.accentCoral,
    uk: { title: 'Тривога після', sub: 'переїзду в іншу країну' },
  },
]
