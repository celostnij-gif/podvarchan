...
export const SERVICES: Service[] = [
  { slug: 'gipnoterapiya-onlayn', category: 'gipnoterapiya', priority: 1, icon: '✨', ctaLink: '/kontakty/', updatedAt: '2026-07-01' },
  { slug: 'onlajn-konsultaciya-psyhologa', category: 'zagalni-zapit', priority: 1, icon: '👤', ctaLink: '/kontakty/', updatedAt: '2026-07-01' },
  { slug: 'psyholog-bioenergetyk', category: 'zagalni-zapit', priority: 1, icon: '🔮', ctaLink: '/kontakty/', updatedAt: '2026-07-01' },
  { slug: 'trevoga-i-panicheskiye-ataki', category: 'trevoga', priority: 1, icon: '🫂', ctaLink: '/kontakty/', updatedAt: '2026-07-10' },
  { slug: 'rabota-s-podsoznaniem', category: 'podsoznanie', priority: 2, icon: '🌌', ctaLink: '/kontakty/', updatedAt: '2026-07-05' },
  { slug: 'samosabotazh-i-bloki', category: 'samosabotazh', priority: 2, icon: '🔓', ctaLink: '/kontakty/', updatedAt: '2026-07-05' },
  { slug: 'emotsionalnoye-vygoraniye', category: 'vygoraniye', priority: 2, icon: '🕯️', ctaLink: '/kontakty/', updatedAt: '2026-07-05' },
  { slug: 'neyverennost-i-strakh-provala', category: 'neyverennost', priority: 3, icon: '🌟', ctaLink: '/kontakty/', updatedAt: '2026-07-08' },
  { slug: 'psikhosomatika', category: 'psikhosomatika', priority: 3, icon: '🌿', ctaLink: '/kontakty/', updatedAt: '2026-07-08' },
  { slug: 'lichnostnyy-krizis', category: 'krizis', priority: 3, icon: '🌱', ctaLink: '/kontakty/', updatedAt: '2026-07-08' },
  { slug: 'kak-izbavitsya-ot-trevogi', category: 'trevoga', priority: 3, icon: '🦋', ctaLink: '/kontakty/', updatedAt: '2026-07-12' },
  { slug: 'postoyannaya-trevoga-bez-prichiny', category: 'trevoga', priority: 3, icon: '🌫️', ctaLink: '/kontakty/', updatedAt: '2026-07-12' },
  { slug: 'utrennyaya-trevoga', category: 'trevoga', priority: 3, icon: '☀️', ctaLink: '/kontakty/', updatedAt: '2026-07-12' },
  { slug: 'trevoga-pered-snom', category: 'trevoga', priority: 3, icon: '🌙', ctaLink: '/kontakty/', updatedAt: '2026-07-12' },
  { slug: 'trevoga-posle-stressa', category: 'trevoga', priority: 3, icon: '🌊', ctaLink: '/kontakty/', updatedAt: '2026-07-12' },
  { slug: 'vnutrenneye-napryazheniye', category: 'trevoga', priority: 3, icon: '⚡', ctaLink: '/kontakty/', updatedAt: '2026-07-12' },
  { slug: 'navyazchivye-mysli', category: 'trevoga', priority: 3, icon: '🌀', ctaLink: '/kontakty/', updatedAt: '2026-07-12' },
  { slug: 'strakh-budushchego', category: 'trevoga', priority: 3, icon: '🌅', ctaLink: '/kontakty/', updatedAt: '2026-07-12' },
  { slug: 'tsifrovoy-detoks-i-gadzhet-zavisimost', category: 'tsifrovoy-detoks', priority: 2, icon: '📱', ctaLink: '/kontakty/', updatedAt: '2026-07-10' },
]
