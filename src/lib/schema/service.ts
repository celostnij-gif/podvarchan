...
export function practiceSchema(locale: string = 'ru'): Record<string, unknown> {
  ...
  return {
    ...
    description: isUk
      ? 'Психологічна допомога онлайн: тривога, панічні атаки, самосаботаж. Метод — еріксонівський гіпноз.'
      : 'Психологическая помощь онлайн: тревога, панические атаки, самосаботаж. Метод — эриксоновский гипноз.',
    url: SITE.url,
