...
export const SERVICE_SLUG_UK: Record<string, string> = {
  ...
  'neyverennost-i-strakh-provala': 'nevpevnenist-i-strakh-provala',
...
export const BLOG_SLUG_UK: Record<string, string> = {
  ...
  'neyverennost-kak-preodolet': 'nevpevnenist-yak-podolati',
  'pochemu-trevoga-ne-prokhodit-godami': 'chomu-trivoga-ne-minaye-rokamy',
  ...
  'psikhosomatika-golovokruzheniya': 'psihosomatika-zapamorochennya',
