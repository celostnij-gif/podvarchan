...
/**
 * Client component для списка статей блога.
 * Получает данные через props, а не читает из статики напрямую.
 */
...
export default function BlogListClient({ posts }: { posts: BlogPostMeta[] }) {
  ...
  const gridPosts = !activeCategory ? posts.slice(1) : filteredPosts
